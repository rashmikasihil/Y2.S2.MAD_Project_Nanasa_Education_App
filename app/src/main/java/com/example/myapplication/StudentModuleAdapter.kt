...
class StudentModuleAdapter(private val moduleList:ArrayList<Module>, private val listener: StudentDashboard): RecyclerView.Adapter<StudentModuleAdapter.ModuleViewHolder>(){
